...
declare type TargetedProps<T> = Omit<InjectorProps<T>, 'children'> & {
    target: (() => EventTarget | null) | EventTarget | null;
    children?: never;
};
export declare class TargetedInjector<T extends EventTarget> extends React.Component<TargetedProps<T>> {
    static propTypes: {
